...
const CURRICULUM = [
    {
        month: 1,
        title: "Fundamentals",
        focus: "Stance, footwork, and the basic four strikes. Drilling slowly with perfect form beats fast sloppy reps.",
        techniques: [
            { id: "m1t1", title: "Orthodox Stance (hold 2 min)" },
            { id: "m1t2", title: "Forward / Backward Step" },
            { id: "m1t3", title: "Lateral Movement" },
            { id: "m1t4", title: "Pivot (off lead foot)" },
            { id: "m1t5", title: "Jab (1)" },
            { id: "m1t6", title: "Cross (2)" },
            { id: "m1t7", title: "Hook (3)" },
            { id: "m1t8", title: "Teep / Push Kick" }
        ],
        daily_drill: "Shadowboxing: R1 Footwork only → R2 Jab only (200) → R3 Jab-Cross → R4 Full combos → R5 Conditioning finisher (5 x 3 min, Mon/Wed/Fri)"
    },
    {
        month: 2,
        title: "Building Flow",
        focus: "Combinations become automatic — your body knows them before your mind does.",
        techniques: [
            { id: "m2t1", title: "1-2 (Jab-Cross)" },
            { id: "m2t2", title: "1-2-3 (Jab-Cross-Hook)" },
            { id: "m2t3", title: "1-2-Teep" },
            { id: "m2t4", title: "Teep-1-2" },
            { id: "m2t5", title: "Slip-Cross-Hook" },
            { id: "m2t6", title: "Muay Thai Roundhouse Kick (Shin Contact)" }
        ],
        daily_drill: "1-2 Combination (50 reps), then layer in the roundhouse — drive the shin through the target, power from hip rotation"
    },
    {
        month: 3,
