...
export default function CoursesPage() {
    ...
    // New Course Modal State — for setting up a new semester
    ...
    const deleteCourse = (courseId: string) => {
        if (!confirm("Remove this course? This deletes all its topics and scores too — new semester, clean slate.")) return;
    ...
    return (
        <div className="space-y-8">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 bg-gold/10 border border-gold/30 rounded-lg text-gold hover:bg-gold/20 transition-all font-mono text-[10px] uppercase tracking-widest"
                    >
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <div className="flex items-start gap-3">
                                        <div className="text-right">
                                            <p className="font-bebas text-2xl text-gold">{progress || 0}%</p>
                                            <p className="font-mono text-[9px] uppercase text-text-dim">{completedCount}/{totalTopics} UNITs</p>
                                        </div>
                                        <button
                                            onClick={(e) => { e.stopPropagation(); deleteCourse(course.id); }}
                                            className="text-text-dim hover:text-red transition-colors mt-1"
                                            title="Remove course"
                                        >
            ...
            {/* New Course Modal — for setting up a new semester */}
            <AnimatePresence>
                {courseModalOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                        <motion.div
                        ...
                        >
                            ...
                            <h3 className="font-bebas text-2xl mb-2 text-gold">New Course</h3>
                            <p className="font-mono text-[10px] text-text-dim uppercase tracking-widest mb-6 border-b border-border/50 pb-4">
                                Set up a course for a new semester
                            </p>

                            <div className="space-y-4">
                                <div>
                                    <label className="font-mono text-[10px] uppercase tracking-[0.2em] text-text-dim block mb-2">Course Code</label>
                                    <input
                                        type="text"
                                        value={newCourseCode}
                                ...
                                <div>
                                    <label className="font-mono text-[10px] uppercase tracking-[0.2em] text-text-dim block mb-2">Course Name</label>
                                    <input
                                        type="text"
                                        value={newCourseName}
                                        ...
                                        className="w-full bg-bg-base border border-border-2 rounded-lg px-4 py-3 font-mono text-sm focus:border-gold outline-none"
                                    />
                                </div>
                                <div>
                                    <label className="font-mono text-[10px] uppercase tracking-[0.2em] text-text-dim block mb-2">Category</label>
                                    <select
                                    ...
                                    <div className="flex gap-2">
                                        {["#8e68c4", "#4a8fd4", "#3abf6a", "#d47a2a", "#c45a8e", "#38bfb0"].map(c => (
                                            <button
                                                ...
                                                className={cn("w-8 h-8 rounded-full transition-all", newCourseColor === c && "ring-2 ring-offset-2 ring-offset-bg-surface ring-gold")}
                                ...
                                <button
                                    ...
                                    className="w-full bg-gold hover:bg-gold-light text-black font-bebas text-xl tracking-widest py-3 rounded-lg mt-2 disabled:opacity-40"
                                >
                                    Add Course
                                </button>
                            </div>
